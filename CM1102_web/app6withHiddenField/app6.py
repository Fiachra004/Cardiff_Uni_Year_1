...
def singleProductPage(techId):
    form = OpinionForm()
    form.myHiddenField.data = "hello there!"
    if form.validate_on_submit():
        return render_template('SingleTechOpinion.html', technology = technologies[techId],opinion = form.opinion.data, hiddenData = form.myHiddenField.data)
    else:
